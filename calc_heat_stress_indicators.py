...
def get_humidity(huss, p, T):
    ...
    # Saturation vapour pressure (in Pa) according to August-Roche-Magnus equation
    e_s = 610.94 * np.exp(17.625 * T_C / (T_C + 243.04) )
    
    # Relative humidty
    RH = 100 * e / e_s

    #Set RH to 100 if RH>100
...
# Universal Thermal Climate Index (adapted from https://github.com/chriswmackey/ladybug-comfort
#                                  Fiala et al., 2012, doi:10.1007/s00484‐011‐0424‐7
#                                  Bröde et al., 2012, doi:10.1007/s00484‐011‐0454‐1)
#Input:
# - T: temperature in K
# - e: vapour pressure in Pa
#Output:
...
def UTCI(T, e):
    ...
    #UTCI calculation split into chunks to avoid memory overload from applying it to climate model output
